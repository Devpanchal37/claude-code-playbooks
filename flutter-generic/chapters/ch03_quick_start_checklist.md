...
### Step 6 — Seed the four minimum docs files

These four files must have their headers before any agent uses them. An agent that opens an empty file and gets no content may skip it or error silently.
