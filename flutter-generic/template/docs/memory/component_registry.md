...
|-----------|------|------|-------|
| `AuthController` | `auth/presentation/controllers/auth_controller.dart` | State Holder | |
| `AuthBinding` | `auth/presentation/bindings/auth_binding.dart` | DI Binding | |
...
| Component | File | Type | Notes |
|-----------|------|------|-------|
| `FeatureController` | `feature/presentation/controllers/feature_controller.dart` | State Holder | |
| `FeatureBinding` | `feature/presentation/bindings/feature_binding.dart` | DI Binding | |
...
| Component | File | Type | Notes |
|-----------|------|------|-------|
| `SettingsController` | `settings/presentation/controllers/settings_controller.dart` | State Holder | |
| `SettingsBinding` | `settings/presentation/bindings/settings_binding.dart` | DI Binding | |
