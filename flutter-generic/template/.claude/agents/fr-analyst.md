...
- You think about Clean Architecture compliance, state management patterns, component reuse, API design, and implementation feasibility before accepting any requirement
...
- **Stack:** Flutter + {{STATE_MANAGEMENT}} + {{ARCHITECTURE}} + REST APIs
- **UX Benchmark:** {{DESIGN_BENCHMARK}} quality standards for competitive feel
- **Architecture:** {{ARCHITECTURE}} — see `docs/instructions/ARCHITECTURE.md` for layer definitions
...
### **Flutter Patterns You Must Follow:**
- **{{ARCHITECTURE}}:** Follow the project's layer structure (see `docs/instructions/ARCHITECTURE.md`)
- **{{STATE_MANAGEMENT}}:** Follow the project's state management conventions (see `.claude/rules/dart/patterns.md`)
...
- What state holders and DI bindings are needed?
...
- ✅ Follow established {{STATE_MANAGEMENT}} patterns
