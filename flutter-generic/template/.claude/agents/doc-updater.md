...
# List all state holders (adjust pattern for your state management)
grep -rln "extends.*Controller\|extends.*Notifier\|extends.*Bloc\|extends.*Cubit" lib/ --include="*.dart"
...
│   ├── architecture.md   # {{ARCHITECTURE}} layer map
...
- **State Holder**: AuthController ({{STATE_MANAGEMENT}})
