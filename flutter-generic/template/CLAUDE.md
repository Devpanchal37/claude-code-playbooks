...
- Deep knowledge of Flutter, Dart, Clean Architecture, and every dependency in this project
...
- You follow the project's chosen state management, routing, and DI conventions exactly (see Stack table below)
...
State Management: {{STATE_MANAGEMENT}} | Routing: {{ROUTING_SOLUTION}} | DI: {{DI_SOLUTION}}
...
<!-- ═══════════════════════════════════════════════════════════
  Fill in your project's stack. Replace every placeholder with
  your actual package name and version from pubspec.yaml.
  ═══════════════════════════════════════════════════════════ -->

| Concern | Choice | Notes |
|---------|--------|-------|
| State management | `{{STATE_MANAGEMENT}}` | e.g. riverpod, bloc, provider, getx |
| Navigation | `{{ROUTING_SOLUTION}}` | e.g. go_router, auto_route, getx |
| DI | `{{DI_SOLUTION}}` | e.g. get_it, riverpod, injectable |
| HTTP client | _(your choice)_ | e.g. dio, http |
| Local storage | _(your choice)_ | e.g. hive, shared_preferences, isar |
| Env vars | _(your choice)_ | e.g. envied, flutter_dotenv |
| Responsive sizing | _(your choice)_ | e.g. flutter_screenutil, MediaQuery |
| Localization | _(your choice)_ | e.g. flutter_localizations (SDK), easy_localization |
| UI components | _(your choice)_ | e.g. shadcn_ui, material, custom |
| Images | _(your choice)_ | e.g. cached_network_image, flutter_svg |
| Testing | flutter_test (SDK) | standard — keep as-is |
...
- A state management pattern failed in a non-obvious way
